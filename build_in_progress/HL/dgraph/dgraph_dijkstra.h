...
// void dgraph_n_times_dij(dgraph_v_of_v<double> &input_graph, int N, int num_of_threads)
// {
...
//         for (int j = 0; j < N; j++)
//         {
//             dij_dist[i][j] = std::numeric_limits<double>::max();
//         }
//         Qid_595.push(i);
//     }
//     int push_num = 0;
...
//     {
//         if (ideal_dgraph.OUTs[v_k].size() > 0)
//         {
//             results.emplace_back(pool.enqueue([v_k, N] {
//                 dgraph_dijkstra(v_k, N);
//                 return 1;
//             }));
//             push_num++;
//         }
