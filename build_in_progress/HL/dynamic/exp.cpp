...
void exp_element2(string data_name, double weightChange_ratio, int change_times, double max_Maintain_time, int thread_num) {
...
void exp() {
	...
	if (1) {
		...
		for (auto data_name : data_names) {
			exp_element2(data_name, weightChange_ratio, change_times, max_Maintain_time, thread_num);
		}
	}
