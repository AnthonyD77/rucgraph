...
void exp_element3(string data_name, double weightChange_ratio, int change_times, double max_Maintain_time, int thread_num) {
...
void exp_element4(string data_name, int change_times, double max_Maintain_time, int thread_num) {
