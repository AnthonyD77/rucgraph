...
void PLL_PPR_example() {
	...
	if (0) {
		...
		WeightIncreaseMaintenance_improv(ideal_g, mm, 0, 4, 2, pool_dynamic, results_dynamic);
		mm.print_L();
		mm.print_PPR();
	}
	...
	if (1) {
		...
		//WeightDecreaseMaintenance_improv(ideal_g, mm, 0, 3, 3, pool_dynamic, results_dynamic);
		WeightDecrease2021(ideal_g, mm, 0, 3, 3, pool_dynamic, results_dynamic);
		mm.print_L();
		mm.print_PPR();
