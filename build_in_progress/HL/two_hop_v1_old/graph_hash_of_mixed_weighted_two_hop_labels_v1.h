...
vector<vector<two_hop_label_v1>> L_temp_595;  // d����d-1�ֵ�label
...
vector<vector<double>> P_dij_595;
vector<vector<double>> T_dij_595;
...
void graph_hash_of_mixed_weighted_two_hop_clear_global_values() {
    ...
    vector<vector<double>>().swap(P_dij_595);
    vector<vector<double>>().swap(T_dij_595);
...
public:
    ...
    bool use_non_adj_reduc_degree = false;  // use_enhanced2019R2 �� use_non_adj_reduc_degree ò��Ч������һ��
...
double graph_hash_of_mixed_weighted_two_hop_v1_extract_distance_no_reduc_for_canonical_repair(int source, int terminal, int target_v) {
    ...
    if (reduction_measures_2019R1_new_ID[source] == 11) {
        ...
        if (reduction_measures_2019R1_new_ID[terminal] == 11) {
            if (f_2019R1_new_ID[source] == f_2019R1_new_ID[terminal]) {
                ...
                return graph_hash_of_mixed_weighted_two_hop_v1_extract_distance_st_no_R1_for_canonical_repair(f_2019R1_new_ID[source], f_2019R1_new_ID[terminal], target_v);
            }
        }
        /* case 3 */
            ...
            return graph_hash_of_mixed_weighted_two_hop_v1_extract_distance_st_no_R1_for_canonical_repair(f_2019R1_new_ID[source], terminal, target_v);
        }
        ...
        if (reduction_measures_2019R1_new_ID[terminal] == 11) {
            return graph_hash_of_mixed_weighted_two_hop_v1_extract_distance_st_no_R1_for_canonical_repair(source, f_2019R1_new_ID[terminal], target_v);
        }
        /* case 9 -- same with case 4 */
        else if (reduction_measures_2019R1_new_ID[terminal] == 12) {
            return graph_hash_of_mixed_weighted_two_hop_v1_extract_distance_st_no_R1_for_canonical_repair(source, f_2019R1_new_ID[terminal], target_v);
        } else {
            return graph_hash_of_mixed_weighted_two_hop_v1_extract_distance_st_no_R1_for_canonical_repair(source, terminal, target_v);
        }
    }
}
...
void canonical_repair_element1(graph_hash_of_mixed_weighted* instance_graph_pointer, int target_v) {
    ...
    for (; begin != end; begin++) {
        ...
        double query_dis = graph_hash_of_mixed_weighted_two_hop_v1_extract_distance_for_canonical_repair(instance_graph, target_v, vertex, target_v);
...
double graph_hash_of_mixed_weighted_two_hop_v1_extract_distance_no_reduc(vector<vector<two_hop_label_v1>>& L, int source, int terminal) {
    /*return std::numeric_limits<double>::max() is not connected*/
...
/*query dis (final)*/
double graph_hash_of_mixed_weighted_two_hop_v1_extract_distance(vector<vector<two_hop_label_v1>>& L, vector<int>& reduction_measures_2019R2, vector<int>& reduction_measures_2019R1, vector<int>& f_2019R1, graph_hash_of_mixed_weighted& instance_graph, int source, int terminal) {
    if (source == terminal) {
        return 0;
    }
...
vector<pair<int, int>> graph_hash_of_mixed_weighted_two_hop_v1_extract_shortest_path(vector<vector<two_hop_label_v1>>& L, vector<int>& reduction_measures_2019R2, vector<int>& reduction_measures_2019R1, vector<int>& f_2019R1, graph_hash_of_mixed_weighted& instance_graph, int source, int terminal) {
    vector<pair<int, int>> paths;
    if (source == terminal) {
        return paths;
    }
...
pair<int, int> graph_hash_of_mixed_weighted_two_hop_v1_extract_two_predecessors (vector<vector<two_hop_label_v1>>& L, vector<int>& reduction_measures_2019R2, vector<int>& reduction_measures_2019R1, vector<int>& f_2019R1, graph_hash_of_mixed_weighted& instance_graph, int source, int terminal) {
