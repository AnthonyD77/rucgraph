...
void test_VCPLL() {
	...
	/*parameters*/
	int iteration_graph_times = 1e1, iteration_source_times = 10, iteration_terminal_times = 10;
	int V = 600, E = 6000, precision = 1, thread_num = 5;
...
void example_PLL_PSL() {
	...
	//graph_hash_of_mixed_weighted_add_edge(g, 1, 2, 1);
	//graph_hash_of_mixed_weighted_add_edge(g, 1, 3, 2);
	//graph_hash_of_mixed_weighted_add_edge(g, 2, 3, 4);
	////graph_hash_of_mixed_weighted_add_edge(g, 4, 2, 10);
	////graph_hash_of_mixed_weighted_add_edge(g, 4, 3, 10);

	//graph_hash_of_mixed_weighted_add_edge(g, 1, 2, 2);
	//graph_hash_of_mixed_weighted_add_edge(g, 1, 3, 1);
	//graph_hash_of_mixed_weighted_add_edge(g, 1, 4, 2);
	//graph_hash_of_mixed_weighted_add_edge(g, 2, 3, 4);
	//graph_hash_of_mixed_weighted_add_edge(g, 3, 4, 4);
	//graph_hash_of_mixed_weighted_add_edge(g, 5, 2, 10);
